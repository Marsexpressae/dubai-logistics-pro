...
const LCL = () => {
  ...
  ogTitle.setAttribute('content', 'LCL Services | Mars Express');
  let ogDesc = document.querySelector('meta[property="og:description"]') as HTMLMetaElement | null;
  if (!ogDesc) { ogDesc = document.createElement('meta'); ogDesc.setAttribute('property', 'og:description'); document.head.appendChild(ogDesc); }
  ogDesc.setAttribute('content', 'Cost-effective consolidation for smaller consignments with secure handling and full documentation support.');
  let ogImage = document.querySelector('meta[property="og:image"]') as HTMLMetaElement | null;
  if (!ogImage) { ogImage = document.createElement('meta'); ogImage.setAttribute('property', 'og:image'); document.head.appendChild(ogImage); }
  ogImage.setAttribute('content', 'https://www.marsexpress.ae/opengraph-lcl.png');
  ...
  twTitle.setAttribute('content', 'LCL Services | Mars Express');
  ...
  twDesc.setAttribute('content', 'Cost-effective consolidation for smaller consignments with secure handling and full documentation support.');
  ...
  twImage.setAttribute('content', 'https://www.marsexpress.ae/opengraph-lcl.png');
  let canonical = document.querySelector('link[rel="canonical"]') as HTMLLinkElement | null;
  if (!canonical) { canonical = document.createElement('link'); canonical.setAttribute('rel', 'canonical'); document.head.appendChild(canonical); }
  canonical.setAttribute('href', 'https://www.marsexpress.ae/services/lcl');
